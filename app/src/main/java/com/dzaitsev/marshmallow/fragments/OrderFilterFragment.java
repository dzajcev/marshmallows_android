    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        FiltersHelper.getInstance().getOrderFilter()
                .ifPresent(filter -> {
                    ...
                    binding.checkBoxInLine.setChecked(filter.getStatuses().contains(OrderStatus.IN_LINE));
                    ...
                    binding.checkBoxIssued.setChecked(filter.getStatuses().contains(OrderStatus.ISSUED));
                });
        ...
        binding.orderFilterApply.setOnClickListener(v -> {
            ...
            if (binding.checkBoxInLine.isChecked()) {
                ordersFilter.getStatuses().add(OrderStatus.IN_LINE);
            }
            ...
            if (binding.checkBoxIssued.isChecked()) {
                ordersFilter.getStatuses().add(OrderStatus.ISSUED);
            }
